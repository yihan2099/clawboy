...
export const EscrowVaultABI = [
  ...
  {
    "type": "function",
    "name": "emergencySetProtocolTreasury",
    "inputs": [
      {
        "name": "newTreasury",
        "type": "address",
  ...
  {
    "type": "error",
    "name": "SplitTransferFailed",
    "inputs": []
  },
  {
    "type": "error",
    "name": "TimelockNotConfigured",
    "inputs": []
  },
  {
    "type": "error",
